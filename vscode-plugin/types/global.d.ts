// Vendored from the vscode-elements examples repo (no upstream copyright header present):
// https://raw.githubusercontent.com/vscode-elements/examples/refs/heads/react-vite/react-vite/src/global.d.ts
// Declares the <vscode-*> custom elements as React JSX intrinsic elements so TSX code can
// use @vscode-elements/elements components directly (React 19 renders custom elements
// natively; no wrapper package is involved).
import {
  VscodeBadge,
  VscodeButton,
  VscodeCheckbox,
