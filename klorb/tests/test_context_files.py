...
def test_send_turn_no_context_file_interjection_when_untrusted(tmp_path: Path) -> None:
    ...
    # ProjectGuidance interjection, and none of the file's content. (An AvailableSkills
    # interjection may still ride, since internal-tier skills are discoverable regardless of
    # workspace trust -- see docs/specs/skills.md; that's a separate interjection from the
    # context-file one this test is about.)
