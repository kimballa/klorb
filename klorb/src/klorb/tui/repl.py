...
from klorb.tui.formatting import _format_workspace_path, _summarize_reasoning_details
...
class ReplApp(KeyActionsMixin, WorkspaceBootstrapMixin, StatusBarMixin, ReplAppBase):
