...
`docs/adrs/00028-gate-read-hard-boundary-on-workspace-trust.md` and the `.klorb/klorb-config.json`
...
docs/adrs/00087-interject-context-files-as-systeminterjection-not-user-turn.md), the same
