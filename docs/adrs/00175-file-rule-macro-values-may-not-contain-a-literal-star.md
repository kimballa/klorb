...
* Question: `FileAccessTable`/`klorb.sandbox.compute_sandbox_dirs` both classify a
  ...
  docs/adrs/00173-file-rule-wildcard-star-matches-any-characters-including-slash.md). If `${home}` or
...
* Answer: `klorb.config_macros.expand_macros` takes a `forbid_char` parameter; `readFiles`/
  ...
  docs/adrs/00176-malformed-config-macro-drops-the-whole-layer.md, drops the whole layer with an
