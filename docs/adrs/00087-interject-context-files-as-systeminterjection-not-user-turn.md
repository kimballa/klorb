...
`docs/adrs/00044-inject-workspace-context-files-as-a-user-turn.md` had `Session` insert a standalone
...
`docs/adrs/00044-inject-workspace-context-files-as-a-user-turn.md` is left as-is, recording the
