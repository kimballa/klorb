...
* Reasoning: A real pty (via Python's `pty` module or a `pexpect`-style dependency) plus OSC 133
  ...
  a *security* boundary (docs/adrs/00066-reject-trap-debug-as-a-security-boundary.md) doesn't apply
  ...
  non-interactively (docs/adrs/00079-persistent-shell-skips-i-flag-and-bootstraps-rcfile-itself.md), a
